  ...
  return (
    <div className="App">
      ...
      <Header list={searchAlgoList} searchAlgoStates={[searchAlgoName, setSearchAlgoName]} >
        ...
        <Dropdown title="Mazes" list={mazeAlgoList} algoStates={[mazeAlgoName, setMazeAlgoName]} callBackList={[() => { resetGridMap(board, true); generateMaze(board, 0, rowNumber - 1, 0, colNumber - 1, startIdx, goalIdx); }]} />
